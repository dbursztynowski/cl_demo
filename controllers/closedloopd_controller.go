...
func (r *ClosedLoopDReconciler) createMonitoringType1(ctx context.Context, CL *closedlooppoocv1.ClosedLoopD, l mytools.VerbosityLog) error {
...
func (r *ClosedLoopDReconciler) createMonitoringType2(ctx context.Context, CL *closedlooppoocv1.ClosedLoopD, l mytools.VerbosityLog) error {
...
func (r *ClosedLoopDReconciler) createDecisionType1(ctx context.Context, CL *closedlooppoocv1.ClosedLoopD, l mytools.VerbosityLog) error {
...
func (r *ClosedLoopDReconciler) createExecutionType1(ctx context.Context, CL *closedlooppoocv1.ClosedLoopD, l mytools.VerbosityLog) error {
...
func (r *ClosedLoopDReconciler) deleteClosedLoopDMonitoringType1(ctx context.Context, name string, namespace string, l mytools.VerbosityLog) error {
	// Try to retrieve the CR to see if it's already within the Cluster
...
func (r *ClosedLoopDReconciler) deleteClosedLoopDMonitoringType2(ctx context.Context, name string, namespace string, l mytools.VerbosityLog) error {
	// Try to retrieve the CR to see if it's already within the Cluster
	name = name + "-monitoringd"
	clcm := &closedlooppoocv1.MonitoringDv2{}
	err := r.Get(ctx, types.NamespacedName{Name: name, Namespace: namespace}, clcm)
...
func (r *ClosedLoopDReconciler) deleteClosedLoopDDecisionType1(ctx context.Context, name string, namespace string, l mytools.VerbosityLog) error {
	// Try to retrieve the CR to see if it's already within the Cluster
	name = name + "-decisiond"
	clcm := &closedlooppoocv1.DecisionD{}
	err := r.Get(ctx, types.NamespacedName{Name: name, Namespace: namespace}, clcm)
...
func (r *ClosedLoopDReconciler) deleteClosedLoopDExecutionType1(ctx context.Context, name string, namespace string, l mytools.VerbosityLog) error {
	// Try to retrieve the CR to see if it's already within the Cluster
