...
type MonitoringDv2Status struct {
	Affix string `json:"affix,omitempty"`
}
...
type MonitoringDv2 struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   MonitoringDv2Spec   `json:"spec,omitempty"`
	Status MonitoringDv2Status `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// Monitoringv2List contains a list of Monitoringv2
type MonitoringDv2List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MonitoringDv2 `json:"items"`
}

func init() {
	SchemeBuilder.Register(&MonitoringDv2{}, &MonitoringDv2List{})
}
